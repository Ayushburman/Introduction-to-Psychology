...
- **Fregoli syndrome** — Belief that various people the person meets are actually a single person in disguise.
- **Cotard syndrome** — Nihilistic delusion of being dead, not existing, or lacking internal organs.
...
- **Body integrity dysphoria** — Persistent desire to have a healthy limb or body part amputated, feeling it doesn't belong.
...
- **Korsakoff syndrome** — Chronic memory disorder from thiamine deficiency (often alcohol-related), marked by severe anterograde amnesia and confabulation.
...
- **Palinopsia** — Visual images persist or recur after the stimulus is gone.
...
- **Kleptomania** — Recurrent failure to resist urges to steal items not needed for personal use.
...
- **Othello syndrome** — Delusional jealousy; conviction that one's partner is unfaithful despite no evidence.
- **Jerusalem syndrome** — Religiously themed psychotic episode triggered by visiting Jerusalem.
...
A quick note: several of these (Paris syndrome, Stendhal syndrome, Jerusalem syndrome) are more culture-bound/reported phenomena than formal DSM/ICD diagnoses, and glossolalia isn't classified as a disorder at all — worth flagging if you're using this for something exam-oriented where formal nosology matters. Want me to expand any particular category, or note which of these appear in standard psychiatry/neurology curricula vs. case-report literature only?
